...
export class WarehouseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.warehouseService
      ...
      .subscribe(
        (res: HttpResponse<IWarehouse[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInWarehouses(): void {
    this.eventSubscriber = this.eventManager.subscribe('warehouseListModification', () => this.loadPage());
  }
