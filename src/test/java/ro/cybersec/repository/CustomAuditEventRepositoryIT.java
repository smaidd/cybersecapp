...
import ro.cybersec.config.audit.AuditEventConverter;
import ro.cybersec.domain.PersistentAuditEvent;
...
import static ro.cybersec.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
